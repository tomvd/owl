...
/**
 * Provider for METAR weather adapter.
 * <p>
 * This is registered via ServiceLoader.
 * <p>
 * File: META-INF/services/com.owl.core.api.AdapterProvider
 * Contents: com.owl.adapter.metar.MetarAdapterProvider
 */
public class MetarAdapterProvider implements AdapterProvider {

    @Override
    public WeatherAdapter createAdapter() {
        return new MetarAdapter();
    }
    ...
    public ProviderMetadata getMetadata() {
        return new ProviderMetadata(
                ...
                "Polls METAR weather observations from NOAA aviation weather service"
        );
    }
}
